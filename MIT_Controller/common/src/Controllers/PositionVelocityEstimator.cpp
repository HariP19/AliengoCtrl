...
template <typename T>
void LinearKFPositionVelocityEstimator<T>::log_estimate()
{
    this->_saveFileManager->saveValue("\nPOSITION-VELOCITY ESTIMATE" );
    this->_saveFileManager->saveValue("Position" );
    this->_saveFileManager->saveVector(this->_stateEstimatorData.result->position );
    this->_saveFileManager->saveValue("vBody" );
    this->_saveFileManager->saveVector(this->_stateEstimatorData.result->vBody );
    this->_saveFileManager->saveValue("vWorld" );
    this->_saveFileManager->saveVector(this->_stateEstimatorData.result->vWorld );
}
